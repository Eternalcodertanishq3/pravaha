...
WORKER_AGENTS: dict[str, type[BaseAgent]] = {
    "planner": PlannerAgent, "researcher": ResearcherAgent, "coder": CoderAgent,
    "debugger": DebuggerAgent, "critic": CriticAgent, "validator": ValidatorAgent,
    "summarizer": SummarizerAgent, "expander": ExpanderAgent, "translator": TranslatorAgent,
    "reasoning": ReasoningAgent, "merger": MergerAgent, "router": RouterAgent,
    "memory": MemoryAgent, "tool": ToolAgent, "judge": JudgeAgent, "refiner": RefinerAgent,
    "classifier": ClassifierAgent, "extractor": ExtractorAgent, "narrator": NarratorAgent,
    "ensemble": EnsembleAgent,
}

AUDIT_AGENTS: dict[str, type[BaseAgent]] = {
    "syntax_audit": SyntaxAuditAgent, "logic_flaw": LogicFlawAgent,
    "hallucination_hunter": HallucinationHunterAgent, "security_audit": SecurityAuditAgent,
    "performance_profiler": PerformanceProfilerAgent, "consistency_guard": ConsistencyGuardAgent,
    "type_safety": TypeSafetyAgent, "edge_case_hunter": EdgeCaseHunterAgent,
    "test_generator": TestGeneratorAgent, "output_verifier": OutputVerifierAgent,
    "self_reflection": SelfReflectionAgent, "patch_applier": PatchApplierAgent,
}

ALL_AGENTS: dict[str, type[BaseAgent]] = {**WORKER_AGENTS, **AUDIT_AGENTS}

__all__ = [
    "BaseAgent", "AgentOutput", "SharedContext",
    "WORKER_AGENTS", "AUDIT_AGENTS", "ALL_AGENTS",
]
